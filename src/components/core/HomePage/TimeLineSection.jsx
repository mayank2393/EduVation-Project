...
const timeline = [
  {
    Logo: Logo1,
    heading: "Leadership",
    desciption: "Fully committed to the the success company",
  },
  {
    Logo: Logo2,
  ...
  },
  {
    Logo: Logo3,
    heading: "Flexibility",
    desciption: "The ability to switch is an important skills",
  },
  {
    Logo: Logo4,
    heading: "Solve Problem",
  ...
  return (
    <div>
      <div className='flex flex-row gap-15 items-center'>
        {/* HW create dotted lines btw images  */}
        <div className='flex flex-col w-[45%] gap-5'>
          {
            timeline.map( (element,index) => {
              return(
                <div className='flex flex-row gap-6' key={index}>
                  <div className='w-[50px] bg-transparent flex items-center'>
                    <img src={element.Logo} className="bg-transparent" />
                  </div>
